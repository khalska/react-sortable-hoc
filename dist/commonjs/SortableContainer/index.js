...
function sortableContainer(WrappedComponent) {
  ...
  return _temp = _class = function (_Component) {
      ...
      _this.handlePress = function (e) {
        ...
        if (active) {
          var _this$props3 = _this.props,
              ...
              decorateHelper = _this$props3.decorateHelper,
          ...
          _this.helper = decorateHelper(_this.document.body.appendChild(clonedNode));
    ...
    decorateHelper: function decorateHelper(item) {
      return item;
    }
  }, _class.propTypes = {
    ...
    decorateHelper: _propTypes2.default.func
